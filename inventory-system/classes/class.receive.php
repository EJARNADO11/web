...
class Receive{
	...
	public function new_receive($sname,$desc){
		...
		$data = [
			[$sname,$desc,$NOW,$NOW,'1'],
		];
		$stmt = $this->conn->prepare("INSERT INTO tbl_receive(rec_supplier, rec_description,rec_date_added, rec_time_added, rec_status) VALUES (?,?,?,?,?)");
		try {
