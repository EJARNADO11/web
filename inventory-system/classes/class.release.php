...
class Release{
	...
	public function new_release($sname,$desc){
		...
		$stmt = $this->conn->prepare("INSERT INTO tbl_release(rel_customer, rel_description, rel_date_added, rel_time_added, rel_status) VALUES (?,?,?,?,?)");
		try {
