...
<div id="third-submenu">
    ...
    ?>  
    <a href="index.php?page=settings&subpage=users&action=create"><i class="fa-regular fa-square-plus"></i>New User</a> <br> <br>Search <input type="text" id="search" name="search" onkeyup="showResults(this.value)">
    <?php
      }
    ?>
</div>
