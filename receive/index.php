...
<div id="container">
  ...
  <ul> 
     ...
     <li> <a href="index.php?page=receive"><i class="fa-solid fa-tent-arrow-left-right"></i>Recieving</a>  </li>
     <li> <a href="index.php?page=release"><i class="fa-solid fa-tent-arrow-left-right"></i>Releasing</a>  </li>
     <li> <a href="index.php?page=inventory"> <i class="fa-solid fa-gear"> </i>Inventory</a>  </li>
     <li> <a href="index.php?page=settings"> <i class="fa-solid fa-gear"> </i>Settings</a>  </li>
     <li> <a href="logout.php" class="move-right">Log Out</a> </li>
